...
bootstrap_defaults() {
    ...
    # SOURCE: read from config first, fallback main.tex
    SOURCE="${SOURCE:-}"
...
derive_context() {
    ...
    # overrides: just the directory, no whitelist needed
    OVERRIDE_DIR="${CONFIG_overrides_dir:-configs}"
...
export -f derive_context validate_build_context
